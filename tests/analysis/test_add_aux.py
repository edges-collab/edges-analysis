...
from edges.analysis.aux_data import add_thermlog_data, add_weather_data, WeatherError
...
def test_add_thermlog_data():
    ...
    out = add_thermlog_data(
        gsd, 
        thermlog_file=TEST_DATA_PATH / 'thermlog_test_data.txt'
    )
...
def test_add_weather_data():
    ...
    out = add_weather_data(
        gsd, 
        weather_file=TEST_DATA_PATH / 'weather_test_data.txt'
    )
