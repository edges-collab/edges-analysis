...
project = "edges-analysis"
copyright = "2020, EDGES Team"
...
intersphinx_mapping = {
    ...
    "edges-io": ("https://edges-io.readthedocs.io/en/latest/", None),
    "edges-cal": ("https://edges-cal.readthedocs.io/en/latest/", None),
}
