...
def integrated_half_hour_level4(GHA_start=13.5):
	...
	return fb, rb_all, wb_all, d_all, f, rr_all, wr_all, tbn, wbn
...
def spectra_to_residuals(fx, tx_2D, wx_2D, flow, fhigh, Nfg, model_type='LINLOG'):
	...
	for i in range(len(t_2D[:, 0])):
		...
		par = ba.fit_polynomial_fourier(model_type, f/200, t, Nfg, Weights=w)
